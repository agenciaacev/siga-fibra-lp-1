...
const PLANS = [
  {
    ...
    gradient: 'linear-gradient(135deg, #00C9A7 0%, #00DDB8 55%, #00F0CC 100%)',
    shadow: '0 40px 80px rgba(0,201,167,0.45)',
  },
  {
    value: '600',
    unit: 'MB',
...
function SpeedCard3D() {
  ...
  return (
    <div
      ...
      onMouseEnter={() => { if (!isAnimating) setIsHovered(true) }}
      onMouseLeave={() => { setMouseRotate({ x: 0, y: 0 }); setIsHovered(false) }}
    ...
    >
      ...
      >
        ...
        >
            ...
            {PLANS.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 6,
                  borderRadius: 3,
                  background: i === planIndex ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.35)',
          ...
          {/* Content */}
          <div className="relative z-10" style={{ transform: 'translateZ(30px)', paddingTop: '0.5rem' }}>
            <span
            ...
            >
              {plan.value}
              <span style={{ fontSize: '2.8rem', fontWeight: 800, verticalAlign: 'middle' }}>
                {plan.unit}
              </span>
            </div>
